  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center w-full max-w-sm px-6">
        ...
        {/* Avatar */}
        <div className="w-28 h-28 rounded-full bg-white flex items-center justify-center mb-5 shadow-lg border border-slate-200">
        ...
        <div className="mt-8 flex flex-col items-center gap-2">
          <Link href="/register" className="text-blue-600 hover:text-blue-700 text-sm transition font-medium underline underline-offset-4 decoration-blue-200 hover:decoration-blue-600">
            Apply as New Student
          </Link>
          <span className="text-slate-400 text-[10px] text-center px-4">
