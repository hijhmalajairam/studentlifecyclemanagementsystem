...
export default function PermanentAddress({ profile, onUpdate }: { profile: any, onUpdate: () => void }) {
  ...
  useEffect(() => {
    if (profile) {
      setFormData({
        ...
        permanent_pin: profile.permanent_pin || ''
      });
    }
  }, [profile]);
          ...
          <tbody>
            <tr className="border-b border-slate-100">
              ...
              <td className="py-3 w-3/4" colSpan={3}>
                <textarea name="permanent_address" value={formData.permanent_address} onChange={handleChange} className="border border-slate-300 rounded px-2 py-1 w-full text-slate-900 h-20 resize-none" />
              </td>
            </tr>
            <tr className="border-b border-slate-100">
              <td className="py-3 font-semibold text-slate-700 w-1/4">City</td>
              <td className="py-3 w-1/4">
                <input type="text" name="permanent_city" value={formData.permanent_city} onChange={handleChange} className="border border-slate-300 rounded px-2 py-1 w-full text-slate-900" />
              </td>
              <td className="py-3 font-semibold text-slate-700 w-1/4 pl-4">State</td>
              <td className="py-3 w-1/4">
                <input type="text" name="permanent_state" value={formData.permanent_state} onChange={handleChange} className="border border-slate-300 rounded px-2 py-1 w-full text-slate-900" />
              </td>
            </tr>
            <tr>
              <td className="py-3 font-semibold text-slate-700 w-1/4">Pin</td>
              <td className="py-3 w-1/4">
                <input type="text" name="permanent_pin" value={formData.permanent_pin} onChange={handleChange} className="border border-slate-300 rounded px-2 py-1 w-full text-slate-900" />
              </td>
